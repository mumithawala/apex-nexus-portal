<nav class="sticky py-3 top-0 z-50 backdrop-blur-md bg-gray-900/95 border-b border-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <a href="/apex-nexus-portal/" class="flex items-center space-x-2">
                    <!-- Briefcase SVG Icon -->
            ...
            <div class="hidden md:flex items-center space-x-4">
                <?php if (isLoggedIn()): ?>
                    <a href="/apex-nexus-portal/<?php echo userRole(); ?>/dashboard.php" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        Go to Dashboard
                    </a>
                <?php else: ?>
                    <a href="/apex-nexus-portal/login.php" class="px-4 py-2 text-sm font-medium text-white border border-white rounded-lg hover:bg-white hover:text-gray-900 transition-colors duration-200">
                        Login
                    </a>
                    <a href="/apex-nexus-portal/register.php" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        Get Started
                    </a>
                <?php endif; ?>
            </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-gray-800 border-t border-gray-700">
        <div class="px-4 pt-2 pb-3 space-y-1">
            ...
            <?php if (isLoggedIn()): ?>
                <a href="/apex-nexus-portal/<?php echo userRole(); ?>/dashboard.php" class="block px-3 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md mt-4">
                    Go to Dashboard
                </a>
            <?php else: ?>
                <a href="/apex-nexus-portal/login.php" class="block px-3 py-2 text-white border border-white rounded-md mt-4 text-center">
                    Login
                </a>
                <a href="/apex-nexus-portal/register.php" class="block px-3 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md mt-2 text-center">
                    Get Started
                </a>
            <?php endif; ?>
        </div>
