            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="mt-8 bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="/apex-nexus-portal/admin/jobs.php" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <a href="/apex-nexus-portal/admin/companies.php" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <a href="/apex-nexus-portal/admin/candidates.php" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <a href="/apex-nexus-portal/admin/applications.php" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
